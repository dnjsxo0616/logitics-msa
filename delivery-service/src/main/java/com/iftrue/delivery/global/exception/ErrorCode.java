...
public enum ErrorCode {
    ...
    DELIVERY_MANAGER_LIMIT_EXCEEDED(HttpStatus.CONFLICT, "배정 최대 인원을 초과하였습니다.", "DM-002"),
    DELIVERY_MANAGER_INVALID_HUB(HttpStatus.BAD_REQUEST, "배송담당자 유형과 소속 허브 정보가 올바르지 않습니다.", "DM-003"),
    DELIVERY_MANAGER_DUPLICATE(HttpStatus.CONFLICT, "해당 배송 담당자는 이미 존재합니다.", "DM-004")
    ;
